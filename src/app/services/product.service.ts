...
export class ProductService {
  ...
  getProductById(productId:string){     
      return this.http.get("http://localhost:8090/api/shopping/product/getproduct/"+productId);
  }
  ...
  getCartProductsByUser(){
    return this.http.get("http://localhost:8095/api/shopping/product/getproductsbyuser/"+this.loginService.getUserId());
  }

  updateProduct(product:Product){
    return this.http.put("http://localhost:8090/api/shopping/product/update/"+product.id, product, {headers: new HttpHeaders(
      {
        'Authorization': `Bearer ${this.loginService.getToken()}`,
      })});
  }
  ...
  deleteProduct(productId:any){
      return this.http.delete("http://localhost:8090/api/shopping/product/delete/"+productId, {headers: new HttpHeaders(
        {
          'Authorization': `Bearer ${this.loginService.getToken()}`,
        })});  
  }
